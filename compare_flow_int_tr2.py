...
folder4 = r'/data/data_mrcv/45_DATA_HUMANS/HEAD_NECK/TEST_RETEST_PCVIPR/plots/tr/individual'
    ...
    if os.path.isdir(main_folder_path) and main_folder_name.startswith("trtstudyvol"):
        ...
        for subfolder_name in subfolder_names:
            ...
            if os.path.isdir(subfolder_path) and ("flow_int" in subfolder_name):
                ...
                img_name_std = f"Time Resolved Interleaf: Volunteer {volu}"
                img_name_dl = f"Time Resolved Interleaf + DL: Volunteer{volu}"
