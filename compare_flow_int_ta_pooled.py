...
folder4 = r'/data/data_mrcv/45_DATA_HUMANS/HEAD_NECK/TEST_RETEST_PCVIPR/plots/ta' #folder where plots are outputted
        ...
        for subfolder_name in subfolder_names:
            ...
            if os.path.isdir(subfolder_path) and ("flow_int" in subfolder_name):
                ...
                if volu == number_of_volunteers:
                    img_name_std = f"Interleaf: Pooled Data"
                    img_name_dl = f"Interleaf + DL: Pooled Data"
